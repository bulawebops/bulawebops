...
Lately I'm obsessed with what happens when you hand AI a keyboard and see what it ships. :raised_hands:

Currently exploring - I'm deep in the "what can I build faster, better, and weirder with AI as a collaborator" phase. Expect experiments, half-finished ideas, and the occasional thing that actually works. That's what the Repositories tab above is for — go poke around. :star2:
